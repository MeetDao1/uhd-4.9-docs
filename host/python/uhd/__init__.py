    ...
    if hasattr(os, "add_dll_directory"):
        ...
        if not uhd_dll_dir or not os.path.exists(os.path.join(uhd_dll_dir, uhd_dll_name)):
            ...
            if uhd_pkg_dir is not None and os.path.exists(
                ...
                UHD_INSTALL_PATH = "/home/zengyi/workarea/X440_Aurora_to_PXIe7902R/toolchain/uhd-4.9"
...
try:
    ...
    def get_pkg_path():
        ...
        if env_path is not None and os.path.isdir(env_path):
            return env_path
        return "/home/zengyi/workarea/X440_Aurora_to_PXIe7902R/toolchain/uhd-4.9"
    ...
    def get_pkg_data_path():
        ...
        if env_path is not None and os.path.isdir(env_path):
            return env_path
        return os.path.join("/home/zengyi/workarea/X440_Aurora_to_PXIe7902R/toolchain/uhd-4.9", "share/uhd")
